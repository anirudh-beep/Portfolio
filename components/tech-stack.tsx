...
export default function TechStack() {
  ...
  const technologies = {
    languages: {
      ...
      description: "Languages I've learned and used in projects",
      skills: [
        { name: "C++", level: 75 },
        { name: "C", level: 70 },
        { name: "Java", level: 65 },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="max-w-2xl mx-auto text-foreground">
            As a BTech student with one year of experience, I'm constantly expanding my knowledge and skills through
            academic studies and practical projects.
          </p>
        </motion.div>
      </div>
    </section>
